          ...
          <main className="flex flex-col gap-5 flex-1">
            <section className="grid grid-cols-4 gap-5">
              ...
              <div className="flex justify-between items-center rounded-3xl p-5 bg-white">
                ...
                <div className="flex size-12 rounded-full bg-[#C7C7F8]/40 items-center justify-center">
                   <UserGroupIcon className="size-5 text-[#6366F1]" />
                </div>
              </div>
              ...
              <div
                id="Total-Revenue"
                className="flex justify-between items-center rounded-3xl p-5 bg-white"
              >
                <div className="flex flex-col">
                  <p className="text-base font-medium text-font mb-4">
                    Total Penghasilan
                      ...
                      <div className="flex items-center justify-between gap-3 p-5">
                        ...
                        <div className="flex items-center space-x-2">
                          <img
                            ...
                            alt="icon"
                          />
                          <p className="font-semibold text-lg text-nowrap text-font">
                            {tx.merchant.name}
                          </p>
                        </div>
                      </div>
                              ...
                              <div className="overflow-hidden shadow-sm outline-1 outline-black/5">
                                <table className="relative min-w-full divide-y divide-border">
                                  <thead className="bg-gray-50">
                                    <tr>
                                      <th className="py-3 pr-3 pl-4 text-left text-sm font-semibold text-gray-900 sm:pl-5">
                                        Produk
                                      </th>
                                      ...
                                      <th className="py-3 pr-4 pl-3 sm:pr-5">
                                  ...
                                  <tbody className="divide-y divide-gray-200 bg-white">
                                    {tx.transaction_products.map((tp) => (
                                      <tr key={tp.id}>
                                        <td className="py-2 pr-3 pl-4 text-sm font-medium text-gray-900 sm:pl-5 flex items-center gap-3">
                                        ...
                                        <td className="px-3 py-2 text-sm text-gray-500">
                                          Rp{" "}
                                          {(
                                            tp.price * tp.quantity
                                          ).toLocaleString("id")}
                                        </td>
                                        <td className="py-2 pr-4 pl-3 text-right text-sm font-medium sm:pr-5">
                                          <button
                                            onClick={() =>
                                            ...
                                            className="text-white bg-primary pl-3 pr-2 py-1.5 rounded-full font-semibold flex items-center cursor-pointer"
                                          >
                                            Detail
