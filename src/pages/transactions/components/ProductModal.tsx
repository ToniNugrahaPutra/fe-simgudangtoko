...
const ProductModal = ({
  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-10 font-primary" onClose={onClose}>
        <Transition.Child
          as={Fragment}
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-[#292D32B2] backdrop-blur-sm" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="relative flex flex-col flex-1 w-full max-w-[1200px] h-full max-h-[752px] shrink-0 rounded-3xl p-[18px] gap-5 bg-white">
                ...
                <div className="modal-content flex flex-1 overflow-y-auto overscroll-contain hide-scrollbar">
                  <div className="flex flex-col gap-5 w-full">
                    {merchant?.products.map((product) => {
                      ...
                      return (
                        <div key={product.id}
                          className="card-assign flex flex-col rounded-3xl border border-border p-4 gap-5"
                        >
                          ...
                          <div className="flex items-center justify-between">
                            <p className="flex items-center gap-1 font-semibold text-font">
                              <img
                  ...
                  <div
                    id="Empty-State"
                    className="hidden flex flex-col flex-1 items-center justify-center rounded-[20px] border-dashed border-2 border-border gap-6"
                  >
                    <img
